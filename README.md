...
- A token can be setup to access private routes by having server return a
  unique code.

- [ ] What steps can you take in your web apps to keep your data secure?

- By using both private routes and tokens to protect peoples private information.

- [ ] Describe how web servers work.

- Using axios request we are able to communicate with servers to request information using promises.
